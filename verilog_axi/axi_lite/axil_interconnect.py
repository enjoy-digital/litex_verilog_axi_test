...
# AXI Lite Interconnect Interface ----------------------------------------------------------------------

class AXILiteInterconnectInterface:
...
class AXILiteInterconnect(Module):
    def __init__(self, platform):
        self.logger = logging.getLogger("AXILiteInterconnect")
        self.s_axils = {}
        self.m_axils = {}
    ...
    def add_master(self, name=None, m_axil=None, origin=None, size=None):
        ...
        m_axil = AXILiteInterconnectInterface(
            axi    = m_axil,
            origin = origin,
            size   = size
        )
    ...
    def do_finalize(self):
        ...
        # Get/Check Parameters.
        # ---------------------
        self.logger.info(f"Finalized {len(self.s_axils)}X{len(self.m_axils)} Interconnect:")
    ...
    def add_sources(platform):
        ...
        platform.add_source(os.path.join(rtl_dir, "axil_interconnect.v"))
